""" inspiration:    http://code.activestate.com/recipes/578589-poker-hands/ 
altered and prospective approach to the problem """

import collections
import itertools
import random
#creating the 2 different lists of suits and numerals.
SUIT_LIST = ("Hearts", "Spades", "Diamonds", "Clubs")
NUMERAL_LIST = ("2", "3", "4", "5", "6", "7", "8", "9", "10", "Jack", "Queen", "King", "Ace")
#defining a class card which represents a card,a combination of suit and numeral.
class card:
